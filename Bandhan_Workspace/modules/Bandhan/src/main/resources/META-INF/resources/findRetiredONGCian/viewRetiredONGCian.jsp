...
<%
User userData=(User)request.getAttribute("retiredUser");
%>
...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td rowspan="2" class="clr1" align="center">
			<img src="<%= themeDisplay.getURLPortal()%>/o/blade/bandhanServlet/bandhanImageServlet?cpfno=<%= userData.getCpfNo() %>" width="150"
				height="100"></td>
		</tr>
		<tr>
