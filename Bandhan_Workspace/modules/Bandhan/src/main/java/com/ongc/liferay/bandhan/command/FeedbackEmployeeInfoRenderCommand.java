...
public class FeedbackEmployeeInfoRenderCommand implements MVCRenderCommand{

	public final static String renderingEmployeePagePath = "/feedback/feedbackEmployeeInfo.jsp";
