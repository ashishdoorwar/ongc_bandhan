...
@Component(
		 ...
		 "mvc.command.name=search_active_ONGCian"
		 }, service = MVCRenderCommand.class
		 )
public class SearchFindActiveONGCian implements MVCRenderCommand{
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		List<User> userList = searchService.searchUserMaster(user);
		renderRequest.setAttribute("userList", userList);
		return "/findActiveONGCian/list.jsp";
	}
