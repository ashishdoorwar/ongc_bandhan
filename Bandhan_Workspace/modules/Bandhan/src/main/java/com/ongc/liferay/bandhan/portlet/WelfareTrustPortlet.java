...
@Component(
		...
		property = {
				...
				"javax.portlet.display-name=WelfareTrust",
				"javax.portlet.init-param.template-path=/",
				"javax.portlet.init-param.view-template=/welfareTrust/view.jsp",
...
public class WelfareTrustPortlet  extends MVCPortlet{
